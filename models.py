...
class BoTNet_with_classifier(nn.Module):
    def __init__(self, block, num_blocks, resolution=(14, 14), heads=4, num_classes=1):
        super(BoTNet_with_classifier, self).__init__()
        self.in_planes = 32
        self.resolution = list(resolution)
        ...
        self.layer4 = self._make_layer(block, 256, num_blocks[3], stride=2, heads=heads, mhsa=True)
